...
class Report:
    def __init__(self, name, data):
        self.name = name
        self.data = data
        self.model = self.data.get('model', False) or self.env.context.get('active_model', False)
    ...
    def execute(self):
        ...
        data = self.env['ir.actions.report.xml'].read(ids[0], ['report_rml', 'jasper_output'])
