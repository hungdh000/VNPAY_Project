...
class JasperHandler(BaseHTTPRequestHandler):
    ...
    def execute(self, path):
        ...
        result = netsvc.dispatch_rpc('object', 'execute', (
        database, uid, password, 'ir.actions.report.xml', 'create_xml', model, depth, context))
...
websrv_lib.reg_http_service('/jasper/', JasperHandler)
